...
export const shuffle = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
...
export const previous = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
...
export const next = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const repeat = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const play = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const pause = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const search = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			height={24}
			width={24}
...
export const camera = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			height={24}
			width={24}
...
export const view = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
...
export const sort = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
...
export const refresh = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
...
export const New = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
...
export const display = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg viewBox="0 0 500 500" {...props}>
			<path
				stroke="currentColor"
...
export const personalize = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg viewBox="0 0 500 500" {...props}>
			<path
				stroke="currentColor"
...
export const terminal = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			width="48"
			height="48"
...
export const taskSearch = (props: any) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="-2 -1 26 26"
